 ...
 */
package net.parim.sns.modules.gen.util;
...
import net.parim.sns.common.mapper.JaxbMapper;
import net.parim.sns.common.utils.DateUtils;
import net.parim.sns.common.utils.FileUtils;
import net.parim.sns.common.utils.FreeMarkers;
import net.parim.sns.common.utils.StringUtils;
import net.parim.sns.modules.gen.entity.GenCategory;
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("functionAuthor", StringUtils.isNotBlank(genScheme.getFunctionAuthor())?genScheme.getFunctionAuthor():UserUtils.getUserToken().getName());
