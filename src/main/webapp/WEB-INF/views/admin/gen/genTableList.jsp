...
<head>
	...
	<meta name="menu" content="menu-28"/>
...
<body>
	...
	<form:form id="searchForm" modelAttribute="genTable" action="${ctxAdmin}/gen/genTable/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th class="sort-column name">表名</th><th>说明</th><th class="sort-column class_name">类名</th><th class="sort-column parent_table">父表</th>
			<%-- <shiro:hasPermission name="gen:genTable:edit"> --%><th>操作</th><%-- </shiro:hasPermission> --%></tr></thead>
		<tbody>
		<c:forEach items="${page.content}" var="genTable">
			<tr>
